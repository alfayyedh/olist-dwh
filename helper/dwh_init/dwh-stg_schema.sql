...
CREATE TABLE stg.sellers (
	...
	CONSTRAINT geolocation_fkey FOREIGN KEY (seller_zip_code_prefix) REFERENCES stg.geolocation (geolocation_zip_code_prefix)
);
...
CREATE TABLE stg.order_reviews (
    ...
    CONSTRAINT order_fkey FOREIGN KEY (order_id) REFERENCES stg.orders(order_id)
);
